...
const UserDashboard = () => {
  ...
  const getSeverityColor = (severity) => {
    if (severity === "Low") return "text-yellow-700 border-lime-600 bg-lime-300 border-2";
    if (severity === "Medium") return "text-yellow-700 border-yellow-600 bg-yellow-300 border-2";
    if (severity === "High") return "text-red-800 border-red-600 bg-red-300 border-2";
  };
  ...
  <div className="p-8">
      ...
      <header className="mb-6 text-center">
        <h1 className="text-3xl font-semibold text-gray-800"><span className="text-sky-600">Your Dashboard</span></h1>
      </header>
      ...
      {/* All Incidents Table */}
      <h2 className="text-2xl font-semibold text-gray-800 mb-4 mt-16">All Incidents</h2>
  ...
  <p className="text-gray-600 mb-4">
    Start a conversation with authorities to discuss this incident. Provide updates or ask for guidance in real-time.
  </p>
