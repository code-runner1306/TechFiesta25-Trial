...
const AdminDashboard = () => {
  ...
  <Timer className="text-yellow-400 w-12 h-12 group-hover:scale-110 transition-transform" />
        ...
        {/*NEW INCIDNETS*/}
        {newTasks.length === 0 ? (
  <h2 className="text-2xl my-11 text-white">No New Reports Available</h2>
) : (
  <div>
    <h1 className="text-4xl text-white font-bold mt-10 md:text-left text-center">New Incidents:</h1>
      ...
      {newTasks.map((incident) => (
        ...
        >
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <p className="text-white font-bold text-xl">ID: #{incident.id}</p>
          </div>
        ...
        <h1 className="text-4xl font-semibold mb-5 text-white md:text-left text-center">Accepted Incidents</h1>
  ...
  {completedId.map((incident) => (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="px-4 py-2 border-4 rounded-lg border-green-400 text-green-300 font-bold">Completed</div>
      </div>
