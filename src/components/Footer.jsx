      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-6">
        ...
        <div className="mb-6 lg:mb-0">
          <ul className="flex flex-wrap gap-6 text-sm font-medium">
            ...
            <li>
              <Link to="/about" className="hover:text-[#22d3ee] transition-colors">
                About
              </Link>
            </li>
            <li>
              <Link to="/blogs" className="hover:text-[#22d3ee] transition-colors">
                Blogs
              </Link>
            </li>
            <li>
              <Link to="/about#features" className="hover:text-[#22d3ee] transition-colors">
                Features
              </Link>
            </li>
            <li>
              <Link to="/feedback" className="hover:text-[#22d3ee] transition-colors">
                Feedback
              </Link>
            </li>
            <li>
              <button onClick={handleFaqClick} className="hover:text-[#22d3ee] transition-colors">
                FAQ's
              </button>
            </li>
          </ul>
