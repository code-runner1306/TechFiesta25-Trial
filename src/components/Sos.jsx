...
const Sos = () => {
    ...
    const handleSOSClick = () => {
      ...
      return (
        <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black py-12 rounded-2xl mx-9 my-6 ">
          <div className="flex flex-col items-center">
            ...
            <button
              ...
              className="bg-red-600 text-white font-bold sm:text-2xl sm:px-14 sm:py-4 md:text-2xl md:py-4 md:px-20 lg:text-3xl lg:py-4 lg:px-28 rounded-full shadow-lg hover:bg-red-700 transition duration-300"
            >
              SOS
            </button>
